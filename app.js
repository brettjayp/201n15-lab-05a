...
function multiply(one, two){
    var oneTwo = one * two;
    var output = `The product of ${one} and ${two} is ${oneTwo}.`;
    return [oneTwo, output];
}
...
function sumArray(testArray) { //eslint-disable-line
    var arraySum = sum(testArray[0], sum(testArray[1], testArray[2])[0])[0];
    var output = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${arraySum} is their sum.`;
    return [arraySum, output];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    var arrayProduct = multiply(testArray[0],multiply(testArray[1],testArray[2])[0])[0];
    var output = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${arrayProduct}.`;
    return [arrayProduct, output];
}
